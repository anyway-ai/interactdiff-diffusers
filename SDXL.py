...
if __name__ == '__main__':
    ...
    model = InteractDiffusionUNet2DConditionModel(
        ...
        center_input_sample=config.get("center_input_sample", False),
        flip_sin_to_cos=config.get("flip_sin_to_cos", True),
        freq_shift=config.get("freq_shift", 0),
        down_block_types=tuple(config.get("down_block_types", [])),
        mid_block_type=config.get("mid_block_type"),
